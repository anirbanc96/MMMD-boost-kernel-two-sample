...
Codes and results for comparing the quadratic time MMMD-based test and the linear time MLMMD and LMMD tests are given in [Quadratic and Linear Time Estimates](https://github.com/anirbanc96/MMMD-boost-kernel-two-sample/tree/main/Quadratic%20and%20Linear%20Time%20Estimates) folder. The three comparisons with $d = 20, 75$ and $300$ are given in [OVERSIGMAd20](https://github.com/anirbanc96/MMMD-boost-kernel-two-sample/tree/main/Quadratic%20and%20Linear%20Time%20Estimates/OVERSIGMAd20), [OVERSIGMAd75](https://github.com/anirbanc96/MMMD-boost-kernel-two-sample/tree/main/Quadratic%20and%20Linear%20Time%20Estimates/OVERSIGMAd75) and [OVERSIGMAd300](https://github.com/anirbanc96/MMMD-boost-kernel-two-sample/tree/main/Quadratic%20and%20Linear%20Time%20Estimates/OVERSIGMAd300) folders respectively. 

Codes for understanding trade-off between computational complexity and power of MMMD-based test is given in [MMMDvsMMD](https://github.com/anirbanc96/MMMD-boost-kernel-two-sample/tree/main/Time%20and%20Power%20Comparison/MMMDvsMMD) folder with result presented in [Time and Power Comparison](https://github.com/anirbanc96/MMMD-boost-kernel-two-sample/tree/main/Time%20and%20Power%20Comparison).
