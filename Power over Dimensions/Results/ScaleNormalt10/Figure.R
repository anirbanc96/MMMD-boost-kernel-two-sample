...
pdf(file="ScaleNormalt10.pdf")

plot(d, apply(GEXP[,-c(1,2)], 1, mean), type='b', col=1, pch=1, lwd=1.5, ylim=c(0, 1.0), xlab="Dimension", 
ylab='Power', main="Gaussian and t-distribution Mixture")
