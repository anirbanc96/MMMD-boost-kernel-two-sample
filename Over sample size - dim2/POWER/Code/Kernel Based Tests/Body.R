######## Driver code for estimating power under kernel based tests #############
################################################################################
source("Functions.R")
################################################################################
...
# this matrix is generated by muliplying the following parameter
# with the cov matrix under H0
sigma.mult <- 1.25
...
# first two coordinate for single, last three for multiple kernel tests
...
stopCluster(cl)
################################################################################
# storing average estimated power
