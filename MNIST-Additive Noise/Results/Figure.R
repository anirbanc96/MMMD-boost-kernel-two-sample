...
pdf(file="MNISTNormalData.pdf")

plot(d, apply(GEXP[,-c(1,2)], 1, mean), type='b', col=1, pch=1, lwd=1.5, ylim=c(0, 1), xlab="Noise Strength", 
ylab='Estimated Power', main="MNIST Data with Gaussian Noise")
...
legend("topright", c("Gauss MMMD", "LAP MMMD", "Mixed MMMD", "FR", "Gauss MMD", "LAP MMD"), col=c(1,2,3,4,5,6),
