...
knitr::opts_knit$set(root.dir = '~/Documents/GitHub/boost-kernel-two-sample/MMDAggComparison/one-dim perturbed uniform/MMDAgg Test/MMDAgg-Paper')
```
...
"""
The following code and it's dependencies are taken from 
